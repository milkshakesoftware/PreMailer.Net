...
namespace PreMailer.Net
{
	public class PreMailer
	{
		...
		/// <summary>
		/// Returns a list of CSS sources ('style', 'link' tags etc.) based on the elements given.
		/// <para/>These will be returned in their order of definition.
		/// </summary>
		...
		/// <summary>
		/// Returns a collection of CQ 'link' nodes that can be used to source CSS content.
		/// <para/>
		/// </summary>
		...
		/// <summary>
		/// Returns a collection of CQ 'sytle' nodes that can be used to source CSS content.
		/// <para/>
		/// </summary>
		...
		/// <summary>
		/// Returns the blocks of CSS within the documents supported CSS sources.
		/// <para/>Blocks are returned in the order they are declared within the document.
		/// </summary>
